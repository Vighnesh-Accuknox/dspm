...
class BaseScanner(ABC):
    ...
    """
    def __init__(self, engine: DetectionEngine, config: Dict[str, Any] = None, client=None):
        self.engine = engine
    ...
    def format_finding(self, detector: str, category: str, severity: str, value: str, 
                       resource_id: str, location: str, extra: Dict[str, Any] = None) -> Dict[str, Any]:
        """
